...
ARCH		?= $(SUBARCH)
CROSS_COMPILE	?=/home/AzureUser/gcc-linaro-4.9.4-2017.01-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-
...
AS		= $(CROSS_COMPILE)as
LD		= $(CROSS_COMPILE)ld
REAL_CC		= /home/AzureUser/linux-86/clang-4639204/bin/clang
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE	?= /home/AzureUser/linux-86/clang-4639204/bin/aarch64-linux-gnu-
